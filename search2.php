...
if (isset($_GET['search'])) {
    ...
    $sql = "SELECT * FROM products WHERE itemName LIKE '%$searchQuery%' OR category LIKE '%$searchQuery%'";
...
<body>
    ...
    <div class="container search-container">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="">
                                    ...
                                    <input type="number" name="quantity" id="quantity_<?php echo $row['itemID']; ?>" value="0" min="0" max="5" class="form-control mb-2">
        ...
        <?php else: ?>
            <p class="text-danger text-center">No products found matching your search.</p>
        <?php endif; ?>
    </div>
    <!-- Back Button -->
<div class="text-center">
        <a href="category2.php" class="back-button">Back to Categories</a>
    </div>
