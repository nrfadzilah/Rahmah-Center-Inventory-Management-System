...
<body>
    ...
    <h2>List of Perishable Foods</h2>

    <?php
    //make the query
    $q = "SELECT itemID, itemName, category, quantity, itemImage FROM products ORDER BY itemID";
...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
  echo '<tr>
      ...
      <td align="center"><a href="itemUpdate2.php?id=' . $row['itemID'] . '">Update</a></td>
      <td align="center"><a href="itemDelete2.php?id=' . $row['itemID'] . '">Delete</a></td>
  </tr>';
}
        //close the table
        echo '</table>';
