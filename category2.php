...
<meta charset="UTF-8">
  ...
  <title>Rahmah Center - Category 2</title>
  ...
  <!--================ End Header Menu Area =================-->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            ...
            <form class="form-inline ml-auto" action="search2.php" method="get">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <form method="post" action="">
                                ...
                                <input type="number" name="quantity" id="quantity_<?php echo $item['itemID']; ?>" value="0" min="0" max="5" class="form-control">
