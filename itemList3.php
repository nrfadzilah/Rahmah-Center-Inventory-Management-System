...
<body>
    ...
    <h2>List of Hygiene Products</h2>

    <?php
    //make the query
    $q = "SELECT itemID, itemName, category, quantity, itemImage FROM hygiene ORDER BY itemID";
...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
  echo '<tr>
      ...
      <td align="center"><a href="itemUpdate3.php?id=' . $row['itemID'] . '">Update</a></td>
      <td align="center"><a href="itemDelete3.php?id=' . $row['itemID'] . '">Delete</a></td>
  </tr>';
}
        //close the table
        echo '</table>';
